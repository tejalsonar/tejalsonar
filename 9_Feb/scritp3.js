...
for (let index = 0; index<filmDatan.length; index++) {
    let singleFilmobject = filmData[index];

    console.log(`Title is ${singleFilmobject.Title}`);

    FilmString = filmString+`
    <div><b>Title :</b>${singleFilmobject.Title}</div>
    <div><b>Year :</b>${singleFilmobject.Title}</div>
    <div><b>Rated :</b>${singleFilmobject.Title}</div>
    <div><b>Released :</b>${singleFilmobject.Title}</div>
    <div><b>Runtime :</b>${singleFilmobject.Title}</div>
    <div><b>Gener :</b>${singleFilmobject.Title}</div>`
